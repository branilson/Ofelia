...
#define STRING_CONFIG_H_AUTHOR "Branilson Luiz" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //24V 192W silicone heater into 3mm aluminum (Ofelia #0)
  //from pidautotune
  #define  DEFAULT_bedKp 356.15
  #define  DEFAULT_bedKi 44.36
  #define  DEFAULT_bedKd 714.79
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 152 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 6000, 6000, 500, 6000 }
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_XY_FEEDRATE 112.5   // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
